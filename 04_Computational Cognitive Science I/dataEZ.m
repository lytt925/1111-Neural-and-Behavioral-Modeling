function [v,a,Ter] = dataEZ(Pc,VRT,MRT,s)

%dataEZ  --  Fit the EZ-diffusion model to P(correct) and RTs
%
% [v,a,Ter] = dataEZ(Pc,VRT,MRT)
% [v,a,Ter] = dataEZ(Pc,VRT,MRT,s)
%
...
%
% dataEZ transforms the triad [Pc,VRT,MRT] into the triad [v,a,Ter]:
